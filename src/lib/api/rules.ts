...
export const rulesApi = {
  ...
  /** 检查 Rules 更新 */
  async checkUpdates(): Promise<RuleUpdateInfo[]> {
    return await invoke("check_rule_updates");
  },

  /** 更新单个已安装 Rule */
  async updateInstalled(id: string): Promise<InstalledRule> {
    return await invoke("update_installed_rule", { id });
  },
