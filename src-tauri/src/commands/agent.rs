...
use crate::services::agent::{
    Agent, AgentBackupEntry, AgentRepo, AgentService, AgentUninstallResult, AgentUpdateInfo,
    DiscoverableAgent, ImportAgentSelection,
};
...
pub async fn update_installed_agent(
    ...
    service
        .0
        .update_installed_agent(&app_state.db, &id)
        .await
        .map_err(|e| e.to_string())
}
