...
use crate::services::rule::{
    ...
    RuleUninstallResult, RuleUpdateInfo,
};
...
#[tauri::command]
pub async fn check_rule_updates(
    service: State<'_, RuleServiceState>,
    app_state: State<'_, AppState>,
) -> Result<Vec<RuleUpdateInfo>, String> {
    service
        .0
...
#[tauri::command]
pub async fn update_installed_rule(
    id: String,
    service: State<'_, RuleServiceState>,
    app_state: State<'_, AppState>,
) -> Result<InstalledRule, String> {
